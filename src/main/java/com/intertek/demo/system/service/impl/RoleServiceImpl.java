...
import com.intertek.demo.system.mapper.RoleMapper;
import com.intertek.demo.system.service.IRoleMenuService;
...
public class RoleServiceImpl extends ServiceImpl<RoleMapper, Role> implements IRoleService {
    ...
    public IPage<Role> findRoles(Role role, QueryRequest request) {
        ...
        if(userId==1||userId==8){
            ...
            SortUtil.handlePageSort(request, page, "createTime", ItsConstant.ORDER_DESC, false);
            return this.baseMapper.findRolePage(page, role);
        }else{
            Page<Role> page = new Page<>(request.getPageNum(), request.getPageSize());
            SortUtil.handlePageSort(request, page, "createTime", ItsConstant.ORDER_DESC, false);
            return this.baseMapper.findRolePageByUserId(page, role, userId);
        }
    }
    ...
    public void createRole(Role role) {
        ...
        role.setCreateId(ItsUtil.getCurrentUserId());
    ...
    public void updateRole(Role role) {
        ...
        role.setModifyId(ItsUtil.getCurrentUserId());
    ...
    @Override
    public List<Role> findUserRoles(Integer userId,String roleName) {
        return this.baseMapper.findUserRoles(userId,roleName);
    }
