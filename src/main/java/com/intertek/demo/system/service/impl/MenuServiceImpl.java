...
import com.intertek.demo.system.mapper.MenuMapper;
import com.intertek.demo.system.mapper.RoleMenuMapper;
...
public class MenuServiceImpl extends ServiceImpl<MenuMapper, Menu> implements IMenuService {
    ...
    public MenuTree<Menu> findMenus(Menu menu) {
        ...
        if(userId==1||userId==8){
            ...
            List<Menu> menus = this.baseMapper.findMenuList(userId);
            List<MenuTree<Menu>> trees = this.convertMenus(menus);
            return TreeUtil.buildMenuTree(trees);
        }
    }
    ...
    public void createMenu(Menu menu) {
        ...
        menu.setCreateId(ItsUtil.getCurrentUserId());
        this.setMenu(menu);
    ...
    public void updateMenu(Menu menu) {
        ...
        menu.setModifyId(ItsUtil.getCurrentUserId());
        this.setMenu(menu);
