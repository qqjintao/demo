...
import com.intertek.demo.monitor.endpoint.FebsHttpTraceEndpoint;
import com.intertek.demo.monitor.entity.FebsHttpTrace;
...
public class FebsActuatorController {
    ...
    public ItsResponse httpTraces(String method, String url) {
