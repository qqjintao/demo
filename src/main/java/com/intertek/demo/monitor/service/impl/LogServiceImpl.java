package com.intertek.demo.monitor.service.impl;
...
import com.intertek.demo.common.utils.AddressUtil;
import com.intertek.demo.common.utils.IPUtil;
import com.intertek.demo.common.utils.SortUtil;
import com.intertek.demo.monitor.entity.SystemLog;
import com.intertek.demo.monitor.mapper.LogMapper;
...
public class LogServiceImpl extends ServiceImpl<LogMapper, SystemLog> implements ILogService {
    ...
    public IPage<SystemLog> findLogs(SystemLog systemLog, QueryRequest request) {
        ...
        SortUtil.handlePageSort(request, page, "createTime", ItsConstant.ORDER_DESC, true);
